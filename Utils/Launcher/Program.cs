...
namespace Launcher
{
    class Program
    {
        ...
        */
        ...
        readonly static int LAUNCHES_COUNT = FromConfig("LaunchesCount", 12); // zero or negative number => unlimited launches
        ...
        readonly static int STARTUP_SLEEP = FromConfig("StartupSleep", 2000); // in milliseconds
